...
public class CadastroReserva implements Tela {
    ...
    public void iniciarTela() {
        ...
        dataEntrada = DataFormat.dataStrToSqliteStr(dataEntrada);
        dataSaida = DataFormat.dataStrToSqliteStr(dataSaida);

        Reserva reserva = new Reserva(dataEntrada, dataSaida, "14:00", "12:00", quarto, this.usuario);
